...
Page({
    ...
    onShow: function(e) {
        var a = this;
        this.saveAndGetData("", !0);
        var o = a.data.QrcodeInfo, n = a.data.canvasInfo;
    ...
    createQrcode: function(e) {
        var a = this, o = e.detail.value.canvasWidth, n = a.data.QrcodeInfo, d = a.data.canvasInfo, r = e.detail.value.text;
    ...
    previewImage: function(t) {
        var e = this, a = e.data.canvasInfo;
        wx.canvasToTempFilePath({
            canvasId: a.id,
            success: function(t) {
                var e = t.tempFilePath, a = [];
    ...
    onShareAppMessage: function(t) {
        return {
            title: "一个木函--二维码生成器",
            path: "/pages/tools/createQrcode/createQrcode",
